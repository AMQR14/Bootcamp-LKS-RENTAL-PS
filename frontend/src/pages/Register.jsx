                        ...
                        <div>
                            <form action="" className="mt-8 flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input type="text" name="" id="" placeholder="Enter your username" className="[#2c3258] border-[#353b64] hover:border-[#505a97] transition-all border-2 rounded-md p-2 px-3 focus:outline-none"/>
                                </div>
                                <div className="flex flex-col gap-2">
                                ...
                                <div>
                                    <Link to={'/login'}>
                                        <button className="bg-[#505a97] hover:bg-[#444d8c] p-3 px-4 rounded-md mt-8 w-full">Register</button>
                                    </Link>
                                    <div className="w-full flex justify-end">
                                        <p className="text-sm my-2">Already have an account? <Link to={'/login'} className="underline text-[#7d86be] hover:text-[#505a97]">Login</Link></p>
                                    </div>
                                </div>
                            </form>
                        </div>
